$(document).ready(function() {
  $('#correspondence_project_id').change();
});


$('#correspondence_project_id').live('change', function(event) { 
  $('#correspondence_stakeholder_id').find('option').remove();
  $('#correspondence_stakeholder_id').append("<option>Please select</option>");
...
$('#correspondence_stakeholder_id').live('change', function(event) {
  $('#correspondence_representative_id').find('option').remove();
  $('#correspondence_representative_id').append("<option>Please select</option>");
  var id = $("#"+$(this).attr("id")+" :selected").val();
  if (id == "") {
    $('#correspondence_representative_id').attr('disabled', 'disabled');
  } else {
